...
// #define spray_pi 3.14159265358979323846f
#define SPRAY_PI M_PI
#define SPRAY_TWO_PI 6.283185307179586232f
#define SPRAY_FOUR_PI 12.566370614359172464f

#define SPRAY_ONE_OVER_PI 0.31830988618379069122f
#define SPRAY_ONE_OVER_TWO_PI 0.15915494309189534561f
#define SPRAY_ONE_OVER_FOUR_PI 0.079577471545947672804f
#define SPRAY_ONE_OVER_TWO_PI_SQR 0.050660591821168885722f

#define SPRAY_ONE_OVER_TWOPI SPRAY_ONE_OVER_TWO_PI
#define SPRAY_INV_PI SPRAY_ONE_OVER_PI
#define SPRAY_INV_TWOPI SPRAY_ONE_OVER_TWOPI
#define SPRAY_1_OVER_255 0.00392156862745098f
#define SPRAY_INVALID_COLOR 0xFFFFFFFF
