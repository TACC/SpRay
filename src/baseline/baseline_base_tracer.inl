#if !defined(SPRAY_BASELINE_BASE_TRACER_INL)
#error An implementation of BaseTracer
#endif

namespace spray {
namespace baseline {

template <typename CacheT, typename ScheduleT, typename PartitionT,
          typename ShaderT>
void BaseTracer<CacheT, ScheduleT, PartitionT, ShaderT>::init(
...
template <typename CacheT, typename ScheduleT, typename PartitionT,
          typename ShaderT>
void BaseTracer<CacheT, ScheduleT, PartitionT, ShaderT>::initCommon(
    const Config &cfg, const Camera &camera, Scene<CacheT> *scene,
    HdrImage *image) {
...
template <typename CacheT, typename ScheduleT, typename PartitionT,
          typename ShaderT>
void BaseTracer<CacheT, ScheduleT, PartitionT, ShaderT>::trace() {
  image_->clear();
...
#pragma omp barrier
    ...
    if (num_eyerays) {
      ...
      isectEyeDomains(ndomains, num_eyerays, eyeray_buf, &qs);
    }
#pragma omp barrier
...
template <typename CacheT, typename ScheduleT, typename PartitionT,
          typename ShaderT>
void BaseTracer<CacheT, ScheduleT, PartitionT, ShaderT>::schedule(
...
template <typename CacheT, typename ScheduleT, typename PartitionT,
          typename ShaderT>
void BaseTracer<CacheT, ScheduleT, PartitionT, ShaderT>::resetSentQs(
...
template <typename CacheT, typename ScheduleT, typename PartitionT,
          typename ShaderT>
void BaseTracer<CacheT, ScheduleT, PartitionT, ShaderT>::spliceQs(
...
template <typename CacheT, typename ScheduleT, typename PartitionT,
          typename ShaderT>
void BaseTracer<CacheT, ScheduleT, PartitionT, ShaderT>::spliceRecvQs(
...
template <typename CacheT, typename ScheduleT, typename PartitionT,
          typename ShaderT>
void BaseTracer<CacheT, ScheduleT, PartitionT, ShaderT>::spliceQsMultiProcesses(
    int tid, int id, int ndomains, const std::vector<RayCount> &sched,
    ArenaQs<DRayQItem> *qs, BlockBuffer *send_buf, BlockBuffer *recv_buf) {
  //
  int num_ranks = mpi::size();
...
template <typename CacheT, typename ScheduleT, typename PartitionT,
          typename ShaderT>
void BaseTracer<CacheT, ScheduleT, PartitionT, ShaderT>::genEyeRays(
...
template <typename CacheT, typename ScheduleT, typename PartitionT,
          typename ShaderT>
void BaseTracer<CacheT, ScheduleT, PartitionT, ShaderT>::isectEyeDomains(
...
template <typename CacheT, typename ScheduleT, typename PartitionT,
          typename ShaderT>
void BaseTracer<CacheT, ScheduleT, PartitionT, ShaderT>::processRays(
...
template <typename CacheT, typename ScheduleT, typename PartitionT,
          typename ShaderT>
void BaseTracer<CacheT, ScheduleT, PartitionT, ShaderT>::processShadow(
...
template <typename CacheT, typename ScheduleT, typename PartitionT,
          typename ShaderT>
void BaseTracer<CacheT, ScheduleT, PartitionT, ShaderT>::aggregateStats(
...
template <typename CacheT, typename ScheduleT, typename PartitionT,
          typename ShaderT>
void BaseTracer<CacheT, ScheduleT, PartitionT, ShaderT>::processRay2(
