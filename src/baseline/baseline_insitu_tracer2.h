...
class InsituTracer2 {
 public:
  ...
  int type() const { return TRACER_TYPE_BASELINE_INSITU2; }
...
#define SPRAY_BASELINE_INSITU_TRACER2_INL
#include "baseline/baseline_insitu_tracer2.inl"
#undef SPRAY_BASELINE_INSITU_TRACER2_INL
