...
////     CHECK_NOTNULL(payload);
////
////     procRecvRads(ray_depth, header->domain_id, payload,
///header->payload_count, /                  tcontext); / #pragma omp barrier /
///}
////
//// #pragma omp barrier
////
...
////     CHECK_NOTNULL(payload);
////
////     procRecvShads(header->domain_id, payload, header->payload_count,
///tcontext); / #pragma omp barrier /   } / }
...
void MultiThreadTracer<ShaderT>::trace() {
  // TODO
  CHECK(false) << "trace() not supported";
//// #pragma omp parallel
////   {
